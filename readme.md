...
__BMP__：UCS-4的group0、plane0的码位被称为BMP，等同于UCS-2。<br/>
...
## 0x03 UTF-16
Unicode有15个辅助平面，和一个BMP，BMP中的0XD800到0XDFFF是保留的，没有分给任何的字符。<br/>
在UTF16编码中，BMP可以使用两个字节来表示。而辅助平面的unicode则需要使用四个字节来表示，因为保留的大小等于2^20。<br/><br/>
__具体算法__：<br/>
	unicode = 辅助平面的unicode代码点
